...
from app.models.planning import AcademicRule, AdvisorMessage, PlannerState, Request, StudyPlan
...
__all__ = [
    ...
    'PlatformSetting', 'Request', 'SecurityAudit', 'Skill', 'Student', 'StudentSkill', 'StudyPlan', 'User'
]
